...
const features = [
  {
    ...
    description: "Forget complex SQL or dragging-and-dropping. Ask questions like 'What&apos;s the relationship between A and B?' and watch the chart appear instantly.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Zero-Knowledge Analytics",
    description: "You don&apos;t need to be a data scientist. Our engine handles the schema mapping, data types, and code generation for you.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Instant Visual Intelligence",
    description: "From bar charts to complex trend lines, our AI selects the most effective visualization style based on your specific data structure.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Enterprise-Grade Security",
    description: "We process your metadata to understand your intent, ensuring your actual raw data rows stay secure and private.",
    visual: "security",
  },
];
